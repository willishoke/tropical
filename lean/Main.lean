...
-- Simple fields are typed precisely; ExprNodes, "port name or index", port-ref
-- arrays, and maps stay opaque `Json` (tropical leaves them untyped too).
...
private def fwd (α : Type) [FromJson α] [ToJsonSchema α] [ToJson α]
