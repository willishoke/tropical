...
- Gates: `modal-universe-history`, `modal-oriented-patch`, `modal-phaser`, `block-algebra`, `block-realize`, `block-banked`, `seam-sweep`, `manual:production modal refinement review`
