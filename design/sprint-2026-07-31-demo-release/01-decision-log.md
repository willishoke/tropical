...
| DR-08 | superseded | Select a 384-point, 24 fps two-trace scope profile. | The point budget/cadence remain, but DR-19 replaces two aggregate traces with one independently locked five-mode overlay. |
