...
export function emitWasm(plan: FlatPlan, opts: EmitWasmOptions = {}): EmitWasmResult {
  ...
  // Scheduler postamble (empty on the sink path; retained for the legacy
  // per-instance lowering until Phase 2 removes the scheduler).
  ...
  // back to the temp-mix ÷20, mirroring the native engine's dual path.
